use crate::protocol::{get_string, get_u16, get_u8};
...
mod tests {
    ...
    fn it_works_for_get() {
        ...
        let command_num: u16 = 0;
        buf.push(0); // header bit
        write_u16(&mut buf, command_num);
